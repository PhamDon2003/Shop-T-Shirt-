                            ...
                            <div class="card-body p-md-5">
                                <div class="row justify-content-center">
                                        ...
                                        <form class="mx-1 mx-md-4" action="forgetPassword" method="post">
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    <label class="form-label" for="form3Example1c">Nhập tài khoản</label>
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                                                <div class="form-outline flex-fill mb-0">
                                                    <label class="form-label" for="form3Example1c">Nhập mật khẩu</label>
                                    ...
                                    <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                                        <img src="https://cafefcdn.com/203337114487263232/2023/11/5/39801004820233562146649366843160572662202946n-1756-1699147992136-1699147992652137833186.jpg"
